...
contains
  ...
  subroutine readCH4Params ( ncid )
    ...
    if ( .not. use_aereoxid_prog ) then
	 ...
	 !CH4ParamsInst%f_ch4=0.5	!Jing Tao
	 ...
	 CH4ParamsInst%vmax_ch4_oxid=45.e-7_r8 * 1000._r8 / 3600._r8	!Jing Tao
            ...
            do fp = 1, num_methp
               ...
               if (j > jwt(c) .and. veg_pp%itype(p) /= noveg) then
                  ...
                  if (usefrootc) then
					 ...
					 m_tiller = anpp * nppratio * max(elai(p), 0.05_r8)	!Jing Tao modified
                  end if
